...
$catalogue = new MessageCatalogue('lt', array (
  ...
  array (
    ...
    'This is not a valid IP address.' => 'Ši vertė nėra galiojantis IP adresas.',
    ...
    'This is not a valid International Bank Account Number (IBAN).' => 'Ši vertė nėra galiojantis Tarptautinis Banko Sąskaitos Numeris (IBAN).',
    ...
    'This is not a valid Business Identifier Code (BIC).' => 'Ši vertė nėra galiojantis Verslo Identifikavimo Kodas (BIC).',
    'Error' => 'Klaida',
    'This is not a valid UUID.' => 'Ši vertė nėra galiojantis UUID.',
    ...
    'The detected character encoding is invalid ({{ detected }}). Allowed encodings are {{ encodings }}.' => 'Nustatyta simbolių koduotė yra netinkama ({{ detected }}). Leidžiamos koduotės yra {{ encodings }}.',
    'This value is not a valid MAC address.' => 'Ši vertė nėra galiojantis MAC adresas.',
