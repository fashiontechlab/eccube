...
$catalogue = new MessageCatalogue('nl', array (
  ...
  array (
    ...
    'The filename is too long. It should have {{ filename_max_length }} character or less.|The filename is too long. It should have {{ filename_max_length }} characters or less.' => 'De bestandsnaam is te lang. Het moet {{ filename_max_length }} karakter of minder zijn.',
    'The password strength is too low. Please use a stronger password.' => 'De wachtwoordsterkte is te laag. Gebruik alstublieft een sterker wachtwoord.',
    ...
    'The extension of the file is invalid ({{ extension }}). Allowed extensions are {{ extensions }}.' => 'De extensie van het bestand is ongeldig ({{ extension }}). Toegestane extensies zijn {{ extensions }}.',
    'The detected character encoding is invalid ({{ detected }}). Allowed encodings are {{ encodings }}.' => 'De gedetecteerde karaktercodering is ongeldig ({{ detected }}). Toegestane coderingen zijn {{ encodings }}.',
