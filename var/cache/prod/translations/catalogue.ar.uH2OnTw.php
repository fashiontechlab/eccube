...
$catalogue = new MessageCatalogue('ar', array (
  ...
  array (
    ...
    'This is not a valid IP address.' => 'هذه القيمة ليست عنوان IP صالحًا.',
    ...
    'No temporary folder was configured in php.ini.' => 'لم يتم تكوين مجلد مؤقت في ملف php.ini، أو المجلد المعد لا يوجد.',
    ...
    'This is not a valid Business Identifier Code (BIC).' => 'هذه القيمة ليست رمز معرف الأعمال (BIC) صالحًا.',
    'Error' => 'خطأ',
    ...
    'The detected character encoding is invalid ({{ detected }}). Allowed encodings are {{ encodings }}.' => 'تم اكتشاف ترميز الأحرف غير صالح ({{ detected }}). الترميزات المسموح بها هي {{ encodings }}.',
