...
$catalogue = new MessageCatalogue('sv', array (
  ...
  array (
    ...
    'This is not a valid IP address.' => 'Detta värde är inte en giltig IP-adress.',
    ...
    'This is not a valid International Bank Account Number (IBAN).' => 'Detta värde är inte ett giltigt Internationellt Bankkontonummer (IBAN).',
    ...
    'This is not a valid Business Identifier Code (BIC).' => 'Detta värde är inte en giltig Företagsidentifieringskod (BIC).',
    'Error' => 'Fel',
    'This is not a valid UUID.' => 'Detta värde är inte en giltig UUID.',
    ...
    'This value contains characters that are not allowed by the current restriction-level.' => 'Detta värde innehåller tecken som inte är tillåtna.',
    ...
    'This value is not a valid MAC address.' => 'Detta värde är inte en giltig MAC-adress.',
