...
$catalogue = new MessageCatalogue('et', array (
  ...
  array (
    ...
    'No temporary folder was configured in php.ini.' => 'php.ini-s ei olnud seadistatud ajutist kausta, või seadistatud kaust ei eksisteeri.',
    ...
    'This is not a valid International Bank Account Number (IBAN).' => 'See väärtus ei ole kehtiv Rahvusvaheline Pangakonto Number (IBAN).',
    ...
    'This is not a valid Business Identifier Code (BIC).' => 'See väärtus ei ole kehtiv Äriühingu Tuvastuskood (BIC).',
    'Error' => 'Viga',
