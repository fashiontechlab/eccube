...
$catalogue = new MessageCatalogue('sq', array (
  ...
  array (
    ...
    'No temporary folder was configured in php.ini.' => 'Asnjë dosje e përkohshme nuk është konfiguruar në php.ini, ose dosja e konfiguruar nuk ekziston.',
    ...
    'This is not a valid International Bank Account Number (IBAN).' => 'Kjo vlerë nuk është një Numër i Llogarisë Bankare Ndërkombëtare (IBAN) i vlefshëm.',
    ...
    'This is not a valid Business Identifier Code (BIC).' => 'Kjo vlerë nuk është një Kod Identifikues i Biznesit (BIC) i vlefshëm.',
    'Error' => 'Gabim',
    'This is not a valid UUID.' => 'Kjo vlerë nuk është një UUID i vlefshëm.',
    ...
    'The filename is too long. It should have {{ filename_max_length }} character or less.|The filename is too long. It should have {{ filename_max_length }} characters or less.' => 'Emri i skedarit është shumë i gjatë. Duhet të ketë maksimumi {{ filename_max_length }} karakter ose më pak.|Emri i skedarit është shumë i gjatë. Duhet të ketë maksimumi {{ filename_max_length }} karaktere ose më pak.',
    ...
    'Mixing numbers from different scripts is not allowed.' => 'Përzierja e numrave nga skriptet e ndryshme nuk lejohet.',
  ...
  array (
    ...
    'Too many failed login attempts, please try again in %minutes% minutes.' => 'Shumë përpjekje të pasuksesshme për t\'u identifikuar, ju lutemi provoni përsëri pas %minutes% minutash.',
  ),
));
