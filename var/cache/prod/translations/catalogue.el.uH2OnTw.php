...
$catalogue = new MessageCatalogue('el', array (
  ...
  array (
    ...
    'This is not a valid IP address.' => 'Αυτή η τιμή δεν είναι έγκυρη διεύθυνση IP.',
    ...
    'No temporary folder was configured in php.ini.' => 'Δεν ρυθμίστηκε προσωρινός φάκελος στο php.ini, ή ο ρυθμισμένος φάκελος δεν υπάρχει.',
    ...
    'This is not a valid International Bank Account Number (IBAN).' => 'Αυτή η τιμή δεν είναι έγκυρος Διεθνής Αριθμός Τραπεζικού Λογαριασμού (IBAN).',
    ...
    'This is not a valid Business Identifier Code (BIC).' => 'Αυτή η τιμή δεν είναι έγκυρος Κωδικός Ταυτοποίησης Επιχείρησης (BIC).',
    'Error' => 'Σφάλμα',
    'This is not a valid UUID.' => 'Αυτή η τιμή δεν είναι έγκυρη UUID.',
    ...
    'This value is not a valid MAC address.' => 'Αυτή η τιμή δεν είναι έγκυρη διεύθυνση MAC.',
