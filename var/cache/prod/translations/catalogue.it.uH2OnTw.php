...
$catalogue = new MessageCatalogue('it', array (
  ...
  array (
    ...
    'No temporary folder was configured in php.ini.' => 'Nessuna cartella temporanea è stata configurata in php.ini, o la cartella configurata non esiste.',
    ...
    'This is not a valid International Bank Account Number (IBAN).' => 'Questo valore non è un Numero di Conto Bancario Internazionale (IBAN) valido.',
    ...
    'This is not a valid Business Identifier Code (BIC).' => 'Questo valore non è un Codice Identificativo di Business (BIC) valido.',
    'Error' => 'Errore',
