...
$catalogue = new MessageCatalogue('zh_TW', array (
  ...
  array (
    ...
    'This is not a valid IP address.' => '此值不是有效的IP地址。',
    ...
    'No temporary folder was configured in php.ini.' => 'php.ini 中沒有配置臨時文件夾，或配置的文件夾不存在。',
    ...
    'This is not a valid International Bank Account Number (IBAN).' => '此值不是有效的國際銀行帳戶號碼（IBAN）。',
    ...
    'This is not a valid Business Identifier Code (BIC).' => '此值不是有效的業務識別碼（BIC）。',
    'Error' => '錯誤。',
    'This is not a valid UUID.' => '此值不是有效的UUID。',
    ...
    'The filename is too long. It should have {{ filename_max_length }} character or less.|The filename is too long. It should have {{ filename_max_length }} characters or less.' => '該檔名長度太長，長度不可超過 {{ filename_max_length }} 個字元。',
    'The password strength is too low. Please use a stronger password.' => '該密碼強度太低，請使用更高強度的密碼。',
    'This value contains characters that are not allowed by the current restriction-level.' => '該值包含了目前限制等級不允許的字元。',
    'Using invisible characters is not allowed.' => '不允許使用隱形字元。',
    'Mixing numbers from different scripts is not allowed.' => '不允許混合來自不同語系的數字。',
    'Using hidden overlay characters is not allowed.' => '不允許使用隱藏的覆蓋字元。',
    'The extension of the file is invalid ({{ extension }}). Allowed extensions are {{ extensions }}.' => '無效的副檔名 ({{ extension }}). 允許的副檔名有 {{ extensions }}.',
    'The detected character encoding is invalid ({{ detected }}). Allowed encodings are {{ encodings }}.' => '偵測到的字元編碼無效 ({{ detected }})。允許的編碼為 {{ encodings }}。',
    'This value is not a valid MAC address.' => '這不是一個有效的MAC地址。',
  ...
  array (
    ...
    'Too many failed login attempts, please try again in %minutes% minutes.' => '嘗試登入失敗次數過多，請 %minutes% 分鐘後再試。|嘗試登入失敗次數過多，請 %minutes% 分鐘後再試。',
  ),
));
...
$catalogueJa = new MessageCatalogue('ja', array (
  ...
  array (
    ...
    'This is not a valid IP address.' => 'この値は有効なIPアドレスではありません。',
    ...
    'This is not a valid International Bank Account Number (IBAN).' => 'この値は有効な国際銀行口座番号（IBAN）ではありません。',
    ...
    'This is not a valid Business Identifier Code (BIC).' => 'この値は有効なビジネス識別コード（BIC）ではありません。',
    'Error' => 'エラー',
    'This is not a valid UUID.' => 'この値は有効なUUIDではありません。',
    ...
    'This value is not a valid MAC address.' => 'この値は有効なMACアドレスではありません。',
...
',
  ...
  array (
    ...
    'front.block.topic.title__gelato' => '特別な日に輝くレンタルドレス特集',
    'front.block.topic.title__ice' => 'シーン別おすすめレンタル特集',
    'front.block.eyecatch.title__en' => 'New Products Collection',
    'front.block.eyecatch.title__ja' => '6泊7日ゆったりレンタル、追加料金なし！',
    'front.block.eyecatch.descriptiron' => '特別な日を彩るオケージョンドレスを手軽にレンタル。結婚式やパーティー、二次会など、豊富なデザインからぴったりの一着を選べます。高品質でトレンド感のあるドレスをお手頃価格でご提供。ネットで簡単予約、クリーニング不要で返却もラクラク。お気に入りのドレスを、いつでも手軽に楽しめる新しいスタイルで、大切な日を特別に演出します。ワンランク上のおしゃれを、買わずに楽しむ新しいスタイルをお届けします。
',
    'front.block.eyecatch.description' => '特別な日を彩るオケージョンドレスを手軽にレンタル。結婚式やパーティー、二次会など、豊富なデザインからぴったりの一着を選べます。高品質でトレンド感のあるドレスをお手頃価格でご提供。ネットで簡単予約、クリーニング不要で返却もラクラク。お気に入りのドレスを、いつでも手軽に楽しめる新しいスタイルで、大切な日を特別に演出します。ワンランク上のおしゃれを、買わずに楽しむ新しいスタイルをお届けします。
',
...
',
    ...
    'admin.common.ga.tracking_id' => 'G-XXXXXXXXXX',
    'admin.home' => 'ホーム',
    'admin.login' => 'ログイン',
...
',
    ...
    'tooltip.setting.shop.shop.ga.tracking_id' => 'Googleアナリティクスでアクセス解析を行う場合に設定してください（Googleアナリティクスの規約も参照ください）',
...
$catalogueZh->addFallbackCatalogue($catalogueJa);
