...
$catalogue = new MessageCatalogue('tr', array (
  ...
  array (
    ...
    'This is not a valid IP address.' => 'Bu değer geçerli bir IP adresi değil.',
    ...
    'No temporary folder was configured in php.ini.' => 'php.ini\'de geçici bir klasör yapılandırılmadı, veya yapılandırılan klasör mevcut değil.',
    ...
    'This is not a valid International Bank Account Number (IBAN).' => 'Bu değer geçerli bir Uluslararası Banka Hesap Numarası (IBAN) değil.',
    ...
    'This is not a valid Business Identifier Code (BIC).' => 'Bu değer geçerli bir İşletme Tanımlama Kodu (BIC) değil.',
    'Error' => 'Hata',
    'This is not a valid UUID.' => 'Bu değer geçerli bir UUID değil.',
    ...
    'This value is not a valid MAC address.' => 'Bu değer geçerli bir MAC adresi değil.',
  ...
  array (
    ...
    'Too many failed login attempts, please try again in %minutes% minutes.' => 'Çok fazla başarısız giriş denemesi, lütfen %minutes% dakika sonra tekrar deneyin.|Çok fazla başarısız giriş denemesi, lütfen %minutes% dakika sonra tekrar deneyin.',
  ),
  'KnpPaginatorBundle' => 
  array (
