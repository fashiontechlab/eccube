...
class getTwoFactorAuthControllerService extends Eccube_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['Eccube\\Controller\\Admin\\Setting\\System\\TwoFactorAuthController'] = $instance = new \Eccube\Controller\Admin\Setting\System\TwoFactorAuthController(($container->privates['Eccube\\Repository\\MemberRepository'] ?? $container->load('getMemberRepositoryService')), ($container->privates['security.token_storage'] ?? self::getSecurity_TokenStorageService($container)), ($container->privates['Eccube\\Service\\TwoFactorAuthService'] ?? self::getTwoFactorAuthServiceService($container)));
        ...
        $instance->setContainer(($container->privates['.service_locator.psTnfZl'] ?? $container->load('get_ServiceLocator_PsTnfZlService'))->withContext('Eccube\\Controller\\Admin\\Setting\\System\\TwoFactorAuthController', $container));
