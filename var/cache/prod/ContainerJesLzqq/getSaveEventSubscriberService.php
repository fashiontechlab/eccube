...
class getSaveEventSubscriberService extends Eccube_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['Eccube\\Doctrine\\EventSubscriber\\SaveEventSubscriber'] = new \Eccube\Doctrine\EventSubscriber\SaveEventSubscriber(($container->privates['Eccube\\Request\\Context'] ?? self::getContextService($container)), ($container->services['Eccube\\Common\\EccubeConfig'] ?? self::getEccubeConfigService($container)));
    }
}
