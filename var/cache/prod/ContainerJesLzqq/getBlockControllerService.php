...
class getBlockControllerService extends Eccube_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['Eccube\\Controller\\Admin\\Content\\BlockController'] = $instance = new \Eccube\Controller\Admin\Content\BlockController(($container->privates['Eccube\\Repository\\BlockRepository'] ?? self::getBlockRepositoryService($container)), ($container->privates['Eccube\\Repository\\Master\\DeviceTypeRepository'] ?? self::getDeviceTypeRepositoryService($container)));
        ...
        $instance->setContainer(($container->privates['.service_locator.psTnfZl'] ?? $container->load('get_ServiceLocator_PsTnfZlService'))->withContext('Eccube\\Controller\\Admin\\Content\\BlockController', $container));
