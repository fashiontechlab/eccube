...
class getProductStatusRepositoryService extends Eccube_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['Eccube\\Repository\\Master\\ProductStatusRepository'] = new \Eccube\Repository\Master\ProductStatusRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
