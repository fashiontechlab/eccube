...
class getMaintenanceControllerService extends Eccube_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['Eccube\\Controller\\Admin\\Content\\MaintenanceController'] = $instance = new \Eccube\Controller\Admin\Content\MaintenanceController(($container->services['Eccube\\Service\\SystemService'] ?? self::getSystemServiceService($container)));
        ...
        $instance->setContainer(($container->privates['.service_locator.psTnfZl'] ?? $container->load('get_ServiceLocator_PsTnfZlService'))->withContext('Eccube\\Controller\\Admin\\Content\\MaintenanceController', $container));
