...
class getUserDataControllerService extends Eccube_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['Eccube\\Controller\\UserDataController'] = $instance = new \Eccube\Controller\UserDataController(($container->privates['Eccube\\Repository\\PageRepository'] ?? self::getPageRepositoryService($container)), ($container->privates['Eccube\\Repository\\Master\\DeviceTypeRepository'] ?? self::getDeviceTypeRepositoryService($container)));
        ...
        $instance->setContainer(($container->privates['.service_locator.psTnfZl'] ?? $container->load('get_ServiceLocator_PsTnfZlService'))->withContext('Eccube\\Controller\\UserDataController', $container));
