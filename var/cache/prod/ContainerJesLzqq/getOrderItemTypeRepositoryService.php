...
class getOrderItemTypeRepositoryService extends Eccube_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['Eccube\\Repository\\Master\\OrderItemTypeRepository'] = new \Eccube\Repository\Master\OrderItemTypeRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
