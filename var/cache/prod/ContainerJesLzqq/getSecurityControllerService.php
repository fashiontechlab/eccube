...
class getSecurityControllerService extends Eccube_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['Eccube\\Controller\\Admin\\Setting\\System\\SecurityController'] = $instance = new \Eccube\Controller\Admin\Setting\System\SecurityController(($container->privates['security.token_storage'] ?? self::getSecurity_TokenStorageService($container)));
        ...
        $instance->setContainer(($container->privates['.service_locator.psTnfZl'] ?? $container->load('get_ServiceLocator_PsTnfZlService'))->withContext('Eccube\\Controller\\Admin\\Setting\\System\\SecurityController', $container));
