...
class getLoginHistoryRepositoryService extends Eccube_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['Eccube\\Repository\\LoginHistoryRepository'] = new \Eccube\Repository\LoginHistoryRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)), ($container->privates['Eccube\\Doctrine\\Query\\Queries'] ??= new \Eccube\Doctrine\Query\Queries()));
    }
}
