 ...
 */
class getConsole_Command_CachePoolInvalidateTagsService extends Eccube_KernelProdContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['console.command.cache_pool_invalidate_tags'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\CachePoolInvalidateTagsCommand(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'doctrine.app_cache_pool' => ['privates', '.doctrine.app_cache_pool.taggable', 'get_Doctrine_AppCachePool_TaggableService', true],
            'rate_limiter.cache' => ['privates', '.rate_limiter.cache.taggable', 'get_RateLimiter_Cache_TaggableService', true],
        ], [
            'cache.app' => 'Symfony\\Component\\Cache\\Adapter\\TagAwareAdapter',
            'doctrine.app_cache_pool' => 'Symfony\\Component\\Cache\\Adapter\\TagAwareAdapter',
            'rate_limiter.cache' => 'Symfony\\Component\\Cache\\Adapter\\TagAwareAdapter',
        ]));
