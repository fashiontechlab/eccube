...
class getForgotControllerService extends Eccube_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.psTnfZl'] ?? $container->load('get_ServiceLocator_PsTnfZlService'))->withContext('Eccube\\Controller\\ForgotController', $container));
