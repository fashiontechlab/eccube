...
class getAuthorityControllerService extends Eccube_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['Eccube\\Controller\\Admin\\Setting\\System\\AuthorityController'] = $instance = new \Eccube\Controller\Admin\Setting\System\AuthorityController(($container->privates['Eccube\\Repository\\AuthorityRoleRepository'] ?? self::getAuthorityRoleRepositoryService($container)));
        ...
        $instance->setContainer(($container->privates['.service_locator.psTnfZl'] ?? $container->load('get_ServiceLocator_PsTnfZlService'))->withContext('Eccube\\Controller\\Admin\\Setting\\System\\AuthorityController', $container));
