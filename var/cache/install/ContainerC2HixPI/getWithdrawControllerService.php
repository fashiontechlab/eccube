...
class getWithdrawControllerService extends Eccube_KernelInstallContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.mjcLOvh'] ?? $container->load('get_ServiceLocator_MjcLOvhService'))->withContext('Eccube\\Controller\\Mypage\\WithdrawController', $container));
