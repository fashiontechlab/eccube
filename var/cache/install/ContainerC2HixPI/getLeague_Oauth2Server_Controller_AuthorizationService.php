...
class getLeague_Oauth2Server_Controller_AuthorizationService extends Eccube_KernelInstallContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['league.oauth2_server.controller.authorization'] = new \League\Bundle\OAuth2ServerBundle\Controller\AuthorizationController(($container->privates['league.oauth2_server.authorization_server'] ?? $container->load('getLeague_Oauth2Server_AuthorizationServerService')), ($container->services['event_dispatcher'] ?? self::getEventDispatcherService($container)), new \League\Bundle\OAuth2ServerBundle\Event\AuthorizationRequestResolveEventFactory(($container->privates['league.oauth2_server.converter.scope'] ??= new \League\Bundle\OAuth2ServerBundle\Converter\ScopeConverter()), $a), new \League\Bundle\OAuth2ServerBundle\Converter\UserConverter(), $a, ($container->privates['league.oauth2_server.factory.psr_http'] ?? $container->load('getLeague_Oauth2Server_Factory_PsrHttpService')), ($container->privates['league.oauth2_server.factory.http_foundation'] ??= new \Symfony\Bridge\PsrHttpMessage\Factory\HttpFoundationFactory()), ($container->privates['league.oauth2_server.factory.psr17'] ??= new \Nyholm\Psr7\Factory\Psr17Factory()));
    }
}
