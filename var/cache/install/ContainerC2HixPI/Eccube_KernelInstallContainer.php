...
class Eccube_KernelInstallContainer extends Container
{
    ...
    protected static function get_Container_Private_ProfilerService($container)
    {
        ...
        $instance->add(new \Symfony\Component\HttpKernel\DataCollector\EventDataCollector(new RewindableGenerator(function () use ($container) {
            ...
            yield 'security.event_dispatcher.api' => ($container->privates['security.event_dispatcher.api'] ?? $container->load('getSecurity_EventDispatcher_ApiService'));
    ...
    protected static function getDoctrine_Orm_DefaultEntityManagerService($container, $lazyLoad = true)
    {
        ...
        $c = new \Doctrine\ORM\Mapping\Driver\AttributeDriver([(\dirname(__DIR__, 4).'/src/Eccube/Entity'), (\dirname(__DIR__, 4).'/vendor/league/oauth2-server-bundle/src/Entity')], false);
        ...
        $f = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [(\dirname(__DIR__, 4).'/app/Plugin/Api42/Entity')]);
        $f->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $g = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [(\dirname(__DIR__, 4).'/app/Plugin/Coupon42/Entity')]);
        $g->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $h = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [(\dirname(__DIR__, 4).'/app/Plugin/MailMagazine42/Entity')]);
        $h->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $i = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [(\dirname(__DIR__, 4).'/app/Plugin/ProductReview42/Entity')]);
        $i->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $j = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [(\dirname(__DIR__, 4).'/app/Plugin/Recommend42/Entity')]);
        $j->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $k = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [(\dirname(__DIR__, 4).'/app/Plugin/RelatedProduct42/Entity')]);
        $k->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $l = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [(\dirname(__DIR__, 4).'/app/Plugin/Securitychecker42/Entity')]);
        $l->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $m = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [(\dirname(__DIR__, 4).'/app/Plugin/SiteKit42/Entity')]);
    ...
    protected static function getSecurity_Firewall_MapService($container)
    {
        ...
        return $container->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($a, new RewindableGenerator(function () use ($container) {
            ...
            yield 'security.firewall.map.context.admin' => ($container->privates['.security.request_matcher.AWcoplg'] ?? $container->load('get_Security_RequestMatcher_AWcoplgService'));
