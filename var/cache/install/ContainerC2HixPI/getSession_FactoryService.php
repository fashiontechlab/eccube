 ...
 */
class getSession_FactoryService extends Eccube_KernelInstallContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['session.factory'] = new \Symfony\Component\HttpFoundation\Session\SessionFactory(($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), new \Symfony\Component\HttpFoundation\Session\Storage\NativeSessionStorageFactory($container->getParameter('session.storage.options'), ($container->privates['Eccube\\Session\\Storage\\Handler\\SameSiteNoneCompatSessionHandler'] ?? $container->load('getSameSiteNoneCompatSessionHandlerService')), new \Symfony\Component\HttpFoundation\Session\Storage\MetadataBag('_sf2_meta', 0), false), [$a, 'onSessionUsage']);
    }
}
