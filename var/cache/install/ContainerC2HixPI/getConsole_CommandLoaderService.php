...
class getConsole_CommandLoaderService extends Eccube_KernelInstallContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'league.oauth2_server.command.create_client' => ['privates', '.league.oauth2_server.command.create_client.lazy', 'get_League_Oauth2Server_Command_CreateClient_LazyService', true],
            'league.oauth2_server.command.update_client' => ['privates', '.league.oauth2_server.command.update_client.lazy', 'get_League_Oauth2Server_Command_UpdateClient_LazyService', true],
            'league.oauth2_server.command.delete_client' => ['privates', '.league.oauth2_server.command.delete_client.lazy', 'get_League_Oauth2Server_Command_DeleteClient_LazyService', true],
            'league.oauth2_server.command.list_clients' => ['privates', '.league.oauth2_server.command.list_clients.lazy', 'get_League_Oauth2Server_Command_ListClients_LazyService', true],
            'league.oauth2_server.command.clear_expired_tokens' => ['privates', '.league.oauth2_server.command.clear_expired_tokens.lazy', 'get_League_Oauth2Server_Command_ClearExpiredTokens_LazyService', true],
        ], [
